...
imgur_client_id = '615f0374e68abe8'
imgur_client_secret = '8feaa81963b7ed2defa66dcfb865cd9600a1d689'
...
def make_gif(**kwargs):
    ...
    generate_and_upload_gif(scaled_images)
